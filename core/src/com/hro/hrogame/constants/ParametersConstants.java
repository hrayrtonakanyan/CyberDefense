...
public class ParametersConstants {
    ...
    public static final int BASE_SIMPLE_CANNON_EFFECT_SENSOR_RADIUS = 80;
    public static final int TANK_SIMPLE_CANNON_EFFECT_SENSOR_RADIUS = 80;
    // endregion

    // region HardCannonEffectData
    public static final float HARD_CANNON_EFFECT_COOLDOWN = 10;
    public static final float HARD_CANNON_EFFECT_DAMAGE = 50;
    public static final int HARD_CANNON_EFFECT_TARGET_LIMIT = 1;
    public static final int BASE_HARD_CANNON_EFFECT_SENSOR_RADIUS = 60;
    public static final int TANK_HARD_CANNON_EFFECT_SENSOR_RADIUS = 60;
    // endregion
    ...
    public static final int TANK_HELL_FIRE_EFFECT_SENSOR_RADIUS = 200;
    // endregion

    // region FreezerEffectData
    public static final float FREEZER_EFFECT_COOLDOWN = 10;
    public static final int TANK_FREEZER_EFFECT_SENSOR_RADIUS = 160;
    // endregion

    // region StunnerEffectData
    public static final float STUNNER_EFFECT_COOLDOWN = 10;
    public static final int TANK_STUNNER_EFFECT_SENSOR_RADIUS = 180;
    // endregion

    // region AbsorbShieldEffectData
    public static final float ABSORB_SHIELD_EFFECT_COOLDOWN = 10;
    public static final int TANK_ABSORB_SHIELD_EFFECT_SENSOR_RADIUS = 140;
    // endregion
