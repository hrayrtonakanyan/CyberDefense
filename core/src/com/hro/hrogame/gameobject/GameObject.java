...
public abstract class GameObject extends Entity {
    ...
    public GameObject(Skin skin, GameObjectData data) {
        this.skin = skin;
        initWithData(data);
    ...
    private void initWithData(GameObjectData data) {
        this.data = data;
        setAppearance(data.drawableName);
    ...
    private void addHealthBar(float health) {
        ...
        healthBar = new ProgressBar(0, health, 1, false, skin, StringConstants.HEALTH_BAR);
    ...
    private void initLevelUpAnimation() {
        ...
        particleEffect.load(Gdx.files.internal("lvlup_particle"), skin.getAtlas());
    ...
    protected void setAppearance(String drawableName) {
        data.drawableName = drawableName;
        appearance = new Image(skin.getDrawable(drawableName));
