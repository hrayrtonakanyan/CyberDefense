...
public class FreezeOverTimeEffect extends Effect {
    ...
    // region C-tor
    public FreezeOverTimeEffect(Skin skin, GameObject owner, EntityManager entityManager, SoundController soundController, FreezeOverTimeEffectData data) {
    ...
    private void addAnimation() {
        ...
        particleEffect.load(Gdx.files.internal("freeze_over_time"), skin.getAtlas());
