...
public class StunOverTimeEffect extends Effect {
    ...
    // region C-tor
    public StunOverTimeEffect(Skin skin, GameObject owner, EntityManager entityManager, SoundController soundController, StunOverTimeEffectData data) {
    ...
    private void addAnimation() {
        ...
        particleEffect.load(Gdx.files.internal("stun_over_time"), skin.getAtlas());
